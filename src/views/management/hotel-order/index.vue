<template>
  <MenusLayout>
    <div class="bg-[#F3F5F7] h-full pb-[20px] box-border">
          ...
          <div class="w-[960px] mr-[15px] shrink-1">
            <div class="overflow-hidden mb-[16px] bg-[#F7F8FF] border-[2px] border-solid border-[#fff] rounded-[10px]">
                          ...
                          <Step v-for="(item, index) in hotelDetail?.bizStatusLog?.items">
                            ...
                            <template #icon>
                              <img
                                ...
                                src="https://hx-mp-res.hitrips.cn/b2b-official-website/order-pending-icon.png"
                                mode="scaleToFill"
                                class="w-[16px] h-[16px] mx-auto mt-[6px]"
                              />
                              <img
                                src="https://hx-mp-res.hitrips.cn/b2b-official-website/order-success-icon.png"
                                mode="scaleToFill"
                                class="w-[16px] h-[16px] mx-auto mt-[6px]"
                                v-else
                              />
              ...
              <div class="py-[20px] px-[22px] bg-white rounded-t-[16px]">
                <div class="box-border flex items-center  justify-between h-[58px] px-[24px] mb-[24px] bg-[#F8F8FA] rounded-[10px] ">
                  <div class="flex items-center text-[14px] leading-[22px]">
                    <div class="text-[#767675]">订单号：</div>
                    <div class="text-[#2F2F2F]">{{ hotelDetail?.id }}</div>
                  </div>
                  <div class="flex items-center text-[14px] leading-[22px]">
                  <div class="text-[#767675]">外部订单号：</div>
                  <div class="text-[#2F2F2F]">{{ hotelDetail?.outerOrderSerialNo || '-' }}</div>
                </div>
                  <div class="flex items-center text-[14px] leading-[22px]">
                ...
                <div class="pt-[30px] mt-[30px] border-t border-t-solid border-t-[#E5E6EB]">
                  ...
                  >
                    <img
                      ...
                      src="https://hx-mp-res.hitrips.cn/b2b-official-website/hotel-room.png"
                      alt=""
                    />
            ...
            <div class="p-[24px] bg-white rounded-[10px] mb-[16px]">
              <div class="flex items-center mb-[14px]">
                <img
                  class="w-[20px] h-[20px] mr-[6px]"
                  src="https://hx-mp-res.hitrips.cn/b2b-official-website/cancel-policy.png"
                  alt=""
                />
            ...
            <div class="p-[24px] bg-white rounded-[10px]">
              <div class="flex items-center mb-[14px]">
                <img
                  class="w-[20px] h-[20px] mr-[6px]"
                  src="https://hx-mp-res.hitrips.cn/b2b-official-website/guest-info.png"
                  alt=""
                />
          ...
          <div class="box-border w-[465px] px-[24px] py-[30px] bg-white rounded-[10px]">
              ...
              <div class="flex-auto overflow-hidden">
                ...
                >
                  <img
                    ...
                    src="https://hx-mp-res.hitrips.cn/b2b-official-website/address.png"
                    alt=""
                  />
                ...
                <div class="flex items-center">
                  <img
                    ...
                    src="https://hx-mp-res.hitrips.cn/b2b-official-website/telephone.png"
                    alt=""
                  />
            ...
            <div class="pb-[12px]">
              ...
              <div
                ...
                v-for="item in hotelDetail?.priceDetails?.roomFeeItems"
              >
