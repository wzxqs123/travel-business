<template>
  ...
  >
    ...
    <div class="basis-[463px] shrink-0 grow-0 bg-[#222222] text-[rgba(255,255,255,0.5)] pt-[114px] pb-[36px] pl-[34px] box-border relative w-[463px]">
      <div
...
import { RoomImages } from '@/composable/hotel/hotel.d'
